    ...
    val newState = evalAddress match {
      case Right(EvaluatedAddress(a, i, f)) =>
        val newMix = line.operation match {
          ...
          case Ld1Token => mixWithSymbolHandled.withMemoryUpdated(LD1.apply(TwoSignedBytes(a), MixByte.fromInt(i), MixByte.fromInt(f)).value, state.locationCounter)
          case Ld1nToken => mixWithSymbolHandled.withMemoryUpdated(LD1N.apply(TwoSignedBytes(a), MixByte.fromInt(i), MixByte.fromInt(f)).value, state.locationCounter)
          case Ld2Token => mixWithSymbolHandled.withMemoryUpdated(LD2.apply(TwoSignedBytes(a), MixByte.fromInt(i), MixByte.fromInt(f)).value, state.locationCounter)
          case Ld2nToken => mixWithSymbolHandled.withMemoryUpdated(LD2N.apply(TwoSignedBytes(a), MixByte.fromInt(i), MixByte.fromInt(f)).value, state.locationCounter)
          case Ld3Token => mixWithSymbolHandled.withMemoryUpdated(LD3.apply(TwoSignedBytes(a), MixByte.fromInt(i), MixByte.fromInt(f)).value, state.locationCounter)
          case Ld3nToken => mixWithSymbolHandled.withMemoryUpdated(LD3N.apply(TwoSignedBytes(a), MixByte.fromInt(i), MixByte.fromInt(f)).value, state.locationCounter)
          case Ld4Token => mixWithSymbolHandled.withMemoryUpdated(LD4.apply(TwoSignedBytes(a), MixByte.fromInt(i), MixByte.fromInt(f)).value, state.locationCounter)
          case Ld4nToken => mixWithSymbolHandled.withMemoryUpdated(LD4N.apply(TwoSignedBytes(a), MixByte.fromInt(i), MixByte.fromInt(f)).value, state.locationCounter)
          case Ld5Token => mixWithSymbolHandled.withMemoryUpdated(LD5.apply(TwoSignedBytes(a), MixByte.fromInt(i), MixByte.fromInt(f)).value, state.locationCounter)
          case Ld5nToken => mixWithSymbolHandled.withMemoryUpdated(LD5N.apply(TwoSignedBytes(a), MixByte.fromInt(i), MixByte.fromInt(f)).value, state.locationCounter)
          case Ld6Token => mixWithSymbolHandled.withMemoryUpdated(LD6.apply(TwoSignedBytes(a), MixByte.fromInt(i), MixByte.fromInt(f)).value, state.locationCounter)
          case Ld6nToken => mixWithSymbolHandled.withMemoryUpdated(LD6N.apply(TwoSignedBytes(a), MixByte.fromInt(i), MixByte.fromInt(f)).value, state.locationCounter)
          case LdaToken => mixWithSymbolHandled.withMemoryUpdated(LDA.apply(TwoSignedBytes(a), MixByte.fromInt(i), MixByte.fromInt(f)).value, state.locationCounter)
          case LdanToken => mixWithSymbolHandled.withMemoryUpdated(LDAN.apply(TwoSignedBytes(a), MixByte.fromInt(i), MixByte.fromInt(f)).value, state.locationCounter)
          case LdxToken => mixWithSymbolHandled.withMemoryUpdated(LDX.apply(TwoSignedBytes(a), MixByte.fromInt(i), MixByte.fromInt(f)).value, state.locationCounter)
          case LdxnToken => mixWithSymbolHandled.withMemoryUpdated(LDXN.apply(TwoSignedBytes(a), MixByte.fromInt(i), MixByte.fromInt(f)).value, state.locationCounter)
