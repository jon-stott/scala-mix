...
case object JleToken extends OperatorToken { override def defaultField = Field(0, 9) }
case object JmpToken extends OperatorToken { override def defaultField = Field(0, 0) }
case object JneToken extends OperatorToken { override def defaultField = Field(0, 8) }
